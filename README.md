...
> 学习资料：https://www.bilibili.com/video/BV1xa4y1p7uu?p=6

- [1-初始express](./express-study/notes/1-初始express.md)  
- [2-了解后端路由](./express-study/notes/2-了解后端路由.md) 
- [3-配置静态资源](./express-study/notes/3-配置静态资源.md) 
- [4-解析请求体](./express-study/notes/4-解析请求体.md) 
- [5-文件上传-前端操作](./express-study/notes/5-文件上传-前端操作.md) 
- [6-文件上传-单名字单文件上传](./express-study/notes/6-文件上传-单名字单文件上传.md) 
- [7-文件上传-单名字多文件上传](./express-study/notes/7-文件上传-单名字多文件上传.md) 
- [8-文件上传-多名字多文件上传](./express-study/notes/8-文件上传-多名字多文件上传.md) 
- [9-cookie操作和设置](./express-study/notes/9-cookie操作和设置.md) 
- [10-session的设置和操作](./express-study/notes/10-session的设置和操作.md) 
- [12-art-template服务端渲染](./express-study/notes/12-art-template服务端渲染.md) 
- [13-中间件](./express-study/notes/13-中间件.md)
- [14-了解MVC开发模式](./express-study/notes/14-了解MVC开发模式.md) 
- [15-了解token](./express-study/notes/15-了解token.md) 
- [16-了解jwt](./express-study/notes/16-了解jwt.md)
